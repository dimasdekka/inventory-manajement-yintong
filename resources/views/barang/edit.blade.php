    ...
    <form action="{{ route('barang.update', $barang->id) }}" method="POST">
        ...
        <div class="row g-3 mb-4">
            <div class="col-12 col-md-6">
                ...
                <input type="text" class="form-control form-control-custom w-100 @error('nama_barang') is-invalid @enderror" id="nama_barang" name="nama_barang" value="{{ old('nama_barang', $barang->nama_barang) }}" placeholder="Contoh: Kertas HVS A4 80gr" required>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-12 col-md-4">
                ...
                <select class="form-select form-control-custom w-100 @error('kondisi_barang') is-invalid @enderror" id="kondisi_barang" name="kondisi_barang" required>
                    ...
                    <option value="rusak_ringan" {{ old('kondisi_barang', $barang->kondisi_barang) == 'rusak_ringan' ? 'selected' : '' }}>Rusak Ringan</option>
                    <option value="rusak_berat" {{ old('kondisi_barang', $barang->kondisi_barang) == 'rusak_berat' ? 'selected' : '' }}>Rusak Berat</option>
                </select>
        ...
        <div class="row g-3 mb-4">
            <div class="col-12 col-md-4">
                ...
                <input type="number" step="0.01" class="form-control form-control-custom w-100 @error('harga_satuan') is-invalid @enderror" id="harga_satuan" name="harga_satuan" value="{{ old('harga_satuan', $barang->harga_satuan) }}" placeholder="Contoh: 55000" required>
            ...
            <div class="col-12 col-md-4">
                ...
                <input type="number" class="form-control form-control-custom w-100 @error('stok_minimum') is-invalid @enderror" id="stok_minimum" name="stok_minimum" value="{{ old('stok_minimum', $barang->stok_minimum) }}" required>
            ...
            <div class="col-12 col-md-4">
                ...
                <input type="date" class="form-control form-control-custom w-100 @error('tanggal_masuk') is-invalid @enderror" id="tanggal_masuk" name="tanggal_masuk" value="{{ old('tanggal_masuk', $barang->tanggal_masuk->format('Y-m-d')) }}" required>
        ...
        <div class="row g-3 mb-4">
            <div class="col-12 col-md-6">
                ...
                <textarea class="form-control form-control-custom w-100 @error('spesifikasi') is-invalid @enderror" id="spesifikasi" name="spesifikasi" rows="3" placeholder="Deskripsi fisik barang, ukuran, dll...">{{ old('spesifikasi', $barang->spesifikasi) }}</textarea>
            ...
            <div class="col-12 col-md-6">
                ...
                <textarea class="form-control form-control-custom w-100 @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" rows="3" placeholder="Informasi tambahan terkait barang...">{{ old('keterangan', $barang->keterangan) }}</textarea>
