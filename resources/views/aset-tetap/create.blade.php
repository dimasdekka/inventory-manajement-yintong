    ...
    <form action="{{ route('aset-tetap.store') }}" method="POST">
        ...
        <div class="row g-3 mb-4">
            <div class="col-12 col-md-4">
                ...
                <input type="text" class="form-control form-control-custom w-100" value="{{ $nextKode }}" disabled>
                <div class="form-text text-muted">Kode aset dibuat otomatis oleh sistem.</div>
            </div>

            <div class="col-12 col-md-5">
                <label for="nama_aset" class="form-label-custom">Nama Aset / Gedung <span class="text-danger">*</span></label>
                <input type="text" class="form-control form-control-custom w-100 @error('nama_aset') is-invalid @enderror" id="nama_aset" name="nama_aset" value="{{ old('nama_aset') }}" placeholder="Contoh: Ruko Kantor Cabang BSD" required>
            ...
            <div class="col-12 col-md-3">
                ...
                <select class="form-select form-control-custom w-100 @error('tipe') is-invalid @enderror" id="tipe" name="tipe" required>
                    ...
                    <option value="kantor" {{ old('tipe') == 'kantor' ? 'selected' : '' }}>Kantor</option>
                    <option value="mess_karyawan" {{ old('tipe') == 'mess_karyawan' ? 'selected' : '' }}>Mess Karyawan</option>
                </select>
        ...
        <div class="mb-4">
            ...
            <textarea class="form-control form-control-custom w-100 @error('alamat') is-invalid @enderror" id="alamat" name="alamat" rows="3" placeholder="Jl. Boulevard Raya Blok H4 No. 12, Tangerang..." required>{{ old('alamat') }}</textarea>
        ...
        <div class="row g-3 mb-4">
            <div class="col-12 col-md-3">
                ...
                <input type="number" class="form-control form-control-custom w-100 @error('luas_tanah') is-invalid @enderror" id="luas_tanah" name="luas_tanah" value="{{ old('luas_tanah', 0) }}" min="1" required>
            ...
            <div class="col-12 col-md-3">
                ...
                <input type="number" class="form-control form-control-custom w-100 @error('luas_bangunan') is-invalid @enderror" id="luas_bangunan" name="luas_bangunan" value="{{ old('luas_bangunan', 0) }}" min="1" required>
            ...
            <div class="col-12 col-md-3">
                ...
                <select class="form-select form-control-custom w-100 @error('kondisi_bangunan') is-invalid @enderror" id="kondisi_bangunan" name="kondisi_bangunan" required>
                    ...
                    <option value="perlu_perbaikan" {{ old('kondisi_bangunan') == 'perlu_perbaikan' ? 'selected' : '' }}>Perlu Perbaikan</option>
                    <option value="rusak_berat" {{ old('kondisi_bangunan') == 'rusak_berat' ? 'selected' : '' }}>Rusak Berat</option>
                </select>
        ...
        <div class="row g-3 mb-4">
            <div class="col-12 col-md-4">
                ...
                <input type="number" step="0.01" class="form-control form-control-custom w-100 @error('nilai_perolehan') is-invalid @enderror" id="nilai_perolehan" name="nilai_perolehan" value="{{ old('nilai_perolehan') }}" placeholder="Contoh: 1500000000" required>
            ...
            <div class="col-12 col-md-4">
                ...
                <input type="date" class="form-control form-control-custom w-100 @error('tanggal_perolehan') is-invalid @enderror" id="tanggal_perolehan" name="tanggal_perolehan" value="{{ old('tanggal_perolehan', date('Y-m-d')) }}" required>
            ...
            <div class="col-12 col-md-4">
                ...
                <input type="text" class="form-control form-control-custom w-100 @error('pic') is-invalid @enderror" id="pic" name="pic" value="{{ old('pic') }}" placeholder="Contoh: Budi Santoso" required>
        ...
        <div class="mb-4">
            ...
            <textarea class="form-control form-control-custom w-100 @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" rows="3" placeholder="Informasi tambahan, nomor sertifikat tanah, nama pemilik gedung disewa, dll...">{{ old('keterangan') }}</textarea>
        ...
        <div class="d-flex gap-2 justify-content-end border-top pt-3">
            ...
            <button type="submit" class="btn-custom btn-custom-dark">
                <i class="fa-solid fa-floppy-disk"></i> Simpan Aset Tetap
            </button>
        </div>
    </form>
</div>
